public class SinglyLinkedList<T> {
	...
	// Set the value of head and tail to null
	...
	public void addFirst(T e) {
		...
		size++;
		System.out.println("Added head node: " + head.getElement() + " element.");
	}
	public void addLast(T e) {
		...
		tail = newNode;
		size++;
		System.out.println("Added tail node: " + tail.getElement() + " element.");
	}
